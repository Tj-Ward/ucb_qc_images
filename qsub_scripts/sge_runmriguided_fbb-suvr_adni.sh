...
python qc_master_code.py --project "ADNI" -t="FBB" --ptype="SUVR" -d="/home/jagust/xnat/squid/adni" -o="/home/jagust/petcore/qc/adni/fbb-suvr" -S="(?!000-S-|999-S-)\d{3}-S-\d{4}" --niftialign
# 
