...
python qc_master_code.py --project "ADNI-DEFACE" -t="FBP" --ptype="SUVR" -d="/home/jagust/xnat/squid/adni" -o="/home/jagust/petcore/qc/adni-deface/fbp-suvr" -S="(000-S-|999-S-)\d{4}" --niftialign
# python qc_sync_cluster_and_google.py -p "adni" -t "fbp-suvr" -R
# 
