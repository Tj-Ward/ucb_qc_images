...
python qc_master_code.py --project "SCAN-FREE" -t="FBP" --ptype="SUVR" -d="/home/jagust/xnat/squid/scan-free" -o="/home/jagust/petcore/qc/scan-free/fbp-suvr" -S="NACC\d{4,20}" --mrifree
