...
python qc_master_code.py --project "ADNI" -t="FTP" --ptype="SUVR" -d="/home/jagust/xnat/squid/adni" -o="/home/jagust/petcore/qc/adni/ftp-suvr" -S="(?!000-S-|999-S-)\d{3}-S-\d{4}" --niftialign
#python qc_sync_cluster_and_google.py -p "adni" -t "ftp-suvr" -R
# 
