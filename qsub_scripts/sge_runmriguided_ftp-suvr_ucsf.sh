...
# 
python qc_master_code.py --project "UCSF" -t="FTP" --ptype="SUVR" -d="/home/jagust/xnat/squid/ucsf" -o="/home/jagust/petcore/qc/ucsf/ftp-suvr" -S="B\d{1,10}-\d{1,10}" --niftialign
