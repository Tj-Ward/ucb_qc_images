...
python qc_master_code.py --project "POINTER" -t="MK6240" --ptype="SUVR" -d="/home/jagust/xnat/squid/pointer" -o="/home/jagust/petcore/qc/pointer/mk6240-suvr" -S="\d{5,20}" --niftialign
