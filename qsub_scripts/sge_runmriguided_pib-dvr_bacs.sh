...
# 
python qc_master_code.py --project "BACS" -t="PIB" --ptype="DVR" -d="/home/jagust/xnat/squid/bacs" -o="/home/jagust/petcore/qc/bacs/pib-dvr" -S="B\d{1,10}-\d{1,10}" --niftialign
#python qc_sync_cluster_and_google.py -p "bacs" -t "pib-dvr" -R
# 
